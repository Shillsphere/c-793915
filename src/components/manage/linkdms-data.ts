...
export const linkdmsItems: LinkdmsItem[] = [
  {
    id: '1',
    title: 'Neural networks fundamentals',
    url: '/linkdms/neural-networks',
    type: 'Article',
